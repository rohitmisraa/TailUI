  ...
  return (
    <div className="p-10">
        ...
        <div className="flex justify-between my-10">
            ...
            <button className="py-1 px-6 bg-cl-secondary text-cl-blue-dark text-base rounded-full">Default</button>
            <button className="py-1 px-6 bg-cl-red text-white text-base rounded-full">Red</button>
            <button className="py-1 px-6 bg-cl-pink text-white text-base rounded-full">Pink</button>
            <button className="py-1 px-6 bg-cl-orange text-white text-base rounded-full">Orange</button>
            <button className="py-1 px-6 bg-cl-yellow text-white text-base rounded-full">Yellow</button>
            <button className="py-1 px-6 bg-cl-cyan text-white text-base rounded-full">Cyan</button>
        ...
        {/* ---Bt 1--- */}
        <h2>Un-rounded Buttons</h2>
        <div className="flex justify-between my-10">
            <button className="py-1 px-6 bg-cl-blue text-white text-base ">Default</button>
            <button className="py-1 px-6 bg-cl-secondary text-cl-blue-dark text-base ">Default</button>
            <button className="py-1 px-6 bg-cl-red text-white text-base ">Red</button>
            <button className="py-1 px-6 bg-cl-pink text-white text-base ">Pink</button>
            <button className="py-1 px-6 bg-cl-orange text-white text-base ">Orange</button>
            <button className="py-1 px-6 bg-cl-yellow text-white text-base ">Yellow</button>
            <button className="py-1 px-6 bg-cl-cyan text-white text-base ">Cyan</button>
        ...
        <h1>Gradient Buttons Default</h1>
        <div className="flex justify-between my-10">
            ...
            <button className="py-1 px-6 bg-gradient-to-r from-gr_pink-1 to-gr_pink-2 text-white text-base rounded-lg">Pink</button>
            <button className="py-1 px-6 bg-gradient-to-r from-gr_orange-1 to-gr_orange-2 text-white text-base rounded-lg">Orange</button>
        ...
        <h1>Gradient Buttons Rounded</h1>
        <div className="flex justify-between my-10">
            <button className="py-1 px-6 bg-gradient-to-r from-gr_blue-1 to-gr_blue-2 text-white text-base rounded-full">Default</button>
            <button className="py-1 px-6 bg-gradient-to-r from-gr_red-1 to-gr_red-2 text-white text-base rounded-full">Red</button>
            ...
            <button className="py-1 px-6 bg-gradient-to-r from-gr_yellow-1 to-gr_yellow-2 text-white text-base rounded-full">Yellow</button>
        ...
        <h1>Gradient Buttons unRounded</h1>
        <div className="flex justify-between my-10">
            ...
            <button className="py-1 px-6 bg-gradient-to-r from-gr_pink-1 to-gr_pink-2 text-white text-base ">Pink</button>
            <button className="py-1 px-6 bg-gradient-to-r from-gr_orange-1 to-gr_orange-2 text-white text-base ">Orange</button>
        ...
        <h1>Buttons with right icons</h1>
        <div className="flex justify-between my-10">

            ...
            <div className='overflow-auto pb-10 sm:pb-0'>
                <div className='w-full py-3 bg-white'>
                    <div className="flex py-1 w-max px-2 m-auto">
                        <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark  hover:text-blue-600">FAQ</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark  hover:text-blue-600">Contact us</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark  hover:text-blue-600">Github</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark  hover:text-blue-600">LinkedIn</button></Link>
                    </div>
                </div>
            </div>
            ...
            <div className='overflow-auto pb-10 sm:pb-0'>
                <div className='w-full py-3 bg-white pt-10'>
                    ...
                    <div className="flex py-1 w-max px-2 m-auto my-5">
                        <Link href={'/'}><button className="py-1 px-2 md:px-5 text-cl-grey-dark  hover:text-blue-600">Blog</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-5 text-cl-grey-dark  hover:text-blue-600">FAQ</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-5 text-cl-grey-dark  hover:text-blue-600">Contact us</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-5 text-cl-grey-dark  hover:text-blue-600">Github</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-5 text-cl-grey-dark  hover:text-blue-600">LinkedIn</button></Link>
                        <Link href={'/'}><button className="py-1 px-2 md:px-5 text-cl-grey-dark  hover:text-blue-600">Privacy Policy</button></Link>
                    </div>
                    <div className='h-px w-11/12 m-auto bg-cl-grey-light'></div>
                    <div className='flex justify-between py-3'>
                        <span className="py-1 px-2 md:px-10 text-cl-grey-dark w-max m-auto">© Tailui 2050 - 5020 All right reserved</span>
                ...
                <div className='w py-3 bg-white pt-10'>
                    <div className='grid sm:grid-cols-4 grid-cols-2 w-[700px] pr-10 m-auto'>
                        <div className="grid rounded-lg py-1 w-max my-10 px-2">
                            ...
                            <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark text-left hover:text-blue-600">Buyers</button></Link>
                            <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark text-left hover:text-blue-600">Suppliers</button></Link>
                        ...
                        <div className="grid  rounded-lg py-1 w-max my-10 px-2">
                            ...
                            <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark text-left hover:text-blue-600">Documentation</button></Link>
                            <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark text-left hover:text-blue-600">Components</button></Link>
                            <Link href={'/'}><button className="py-1 px-2 md:px-10 text-cl-grey-dark text-left hover:text-blue-600">Contact</button></Link>
                        </div>
                        <div className="grid  rounded-lg py-1 w-max my-10 px-2">

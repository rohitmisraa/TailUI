            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl my-3'>
                ...
                <div style={{ height: code1 ? '400px' : '0', display: code1 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        ...
                        &lt;div className=&quot; p-2 pb-5 bg-white w-80 rounded-xl&quot; id=&quot;card-with-image&quot;&gt;<br />
                        &lt;div className=&quot;rounded-xl w-full h-52 overflow-hidden&quot;&gt;<br />
                        &lt;img className=&quot;min-h-full&quot;
                        src=&quot;https://cdn.pixabay.com/photo/2021/11/14/18/36/telework-6795505_960_720.jpg&quot; alt=&quot;Tumbnail Image&quot; /&gt;<br />

                        &lt;/div&gt;<br />
                        &lt;div className=&quot;px-2 my-4&quot;&gt;<br />
                        &lt;h2 className=&quot;my-3 font-medium text-lg&quot;&gt;<br />Headline&lt;/h2&gt;<br />
                        &lt;p className=&quot;my-3 text-base text-[#425466]&quot;&gt;<br />Write an amazing description in this dedicated card section. Each word counts. &lt;/p&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;/div&gt;<br />
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl my-3'>
                ...
                <div style={{ height: code1 ? '400px' : '0', display: code1 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        ...
                        &lt;div className=&quot; p-5 pb-5 bg-white w-96 rounded-xl&quot; id=&quot;text-with-button&quot;&gt;<br />
                        ...
                        &lt;button className=&quot;float-right relative bottom-12&quot;&gt;<br />
                        ...
                        &lt;/button&gt;<br />
                        &lt;p className=&quot;text-lg text-cl-blue-dark&quot;&gt;<br />Lorem ipsum dolor sit amet, consectetur adipiscing elit&lt;/p&gt;<br />
                        &lt;Link href=&quot;#&quot; passHref&gt;<br />&lt;button className=&quot;py-1 mt-3 bg-transparent text-current text-base rounded-full&quot;&gt;<br />
                        Apply now
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl my-3'>
                ...
                <div style={{ height: code1 ? '400px' : '0', display: code1 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        ...
                        &lt;div className=&quot; bg-white w-60 pb-5 rounded-xl overflow-hidden&quot; id=&quot;social-media-card&quot;&gt;<br />
                        &lt;div className=&quot;h-2 w-full bg-gradient-to-r from-gr_cyan-1 to-gr_cyan-2&quot;&gt;<br />&lt;/div&gt;<br />
                        &lt;h3 className=&quot;m-4 mb-2 text-2xl font-medium&quot;&gt;<br />@tailui&lt;/h3&gt;<br />
                        &lt;span className=&quot;ml-4 text-xl&quot;&gt;<br />7.5k+&lt;/span&gt;<br />
                        &lt;div className=&quot;flex&quot;&gt;<br />
                        &lt;Link href=&quot;#&quot; passHref&gt;<br />
                        &lt;button className=&quot;py-1 px-6 bg-cl-blue text-white text-base rounded-full ml-4 m-4 mr-10&quot;&gt;<br />Follow&lt;/button&gt;<br />
                        &lt;/Link&gt;<br />
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl my-3' id="project-card">
                ...
                <div style={{ height: code1 ? '400px' : '0', display: code1 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        ...
                        &lt;div className=&quot; p-10 bg-white w-96 rounded-xl&quot; id=&quot;payment-card&quot;&gt;<br />
                        &lt;h2 className=&quot;font-medium text-3xl&quot;&gt;<br />$ 49 &lt;span className=&quot;font-normal text-xl&quot;&gt;<br />/month&lt;/span&gt;<br />&lt;/h2&gt;<br />
                        &lt;h3 className=&quot;font-medium text-3xl my-2&quot;&gt;<br />Base&lt;/h3&gt;<br />
                        &lt;p className=&quot;text-lg&quot;&gt;<br />For freelancers and developers, who want to easily create apps.&lt;/p&gt;<br />
                        &lt;div className=&quot;py-3&quot;&gt;<br />
                        &lt;span className=&quot;flex space-x-2 mb-4&quot;&gt;<br />
                        &lt;div className=&quot;bg-cl-blue rounded-full&quot;&gt;<br />
                        ...
                        &lt;/div&gt;<br />
                        &lt;span className=&quot;ml-4 text-lg&quot;&gt;<br />All premium components&lt;/span&gt;<br />
                        &lt;/span&gt;<br />
                        &lt;span className=&quot;flex space-x-2 mb-4&quot;&gt;<br />
                        &lt;div className=&quot;bg-cl-blue rounded-full&quot;&gt;<br />
                        &lt;svg xmlns=&quot;http://www.w3.org/2000/svg&quot; viewBox=&quot;0 0 512 512&quot; width=&quot;28&quot; height=&quot;28&quot; fill=&quot;#D3DEF0&quot;&gt;<br />&lt;path d=&quot;M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z&quot; /&gt;<br />&lt;/svg&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;span className=&quot;ml-4 text-lg&quot;&gt;<br />All premium blocks&lt;/span&gt;<br />
                        &lt;/span&gt;<br />
                        &lt;span className=&quot;flex space-x-2 mb-4&quot;&gt;<br />
                        &lt;div className=&quot;bg-cl-blue rounded-full&quot;&gt;<br />
                        &lt;svg xmlns=&quot;http://www.w3.org/2000/svg&quot; viewBox=&quot;0 0 512 512&quot; width=&quot;28&quot; height=&quot;28&quot; fill=&quot;#D3DEF0&quot;&gt;<br />&lt;path d=&quot;M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z&quot; /&gt;<br />&lt;/svg&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;span className=&quot;ml-4 text-lg&quot;&gt;<br />Special badge in forum&lt;/span&gt;<br />
                        &lt;/span&gt;<br />
                        &lt;span className=&quot;flex space-x-2 mb-4&quot;&gt;<br />
                        &lt;div className=&quot;bg-cl-blue rounded-full&quot;&gt;<br />
                        &lt;svg xmlns=&quot;http://www.w3.org/2000/svg&quot; viewBox=&quot;0 0 512 512&quot; width=&quot;28&quot; height=&quot;28&quot; fill=&quot;#D3DEF0&quot;&gt;<br />&lt;path d=&quot;M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z&quot; /&gt;<br />&lt;/svg&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;span className=&quot;ml-4 text-lg&quot;&gt;<br />Special support from staff&lt;/span&gt;<br />
                        &lt;/span&gt;<br />
                        &lt;span className=&quot;flex space-x-2 mb-4&quot;&gt;<br />
                        &lt;div className=&quot;bg-cl-blue rounded-full&quot;&gt;<br />
                        &lt;svg xmlns=&quot;http://www.w3.org/2000/svg&quot; viewBox=&quot;0 0 512 512&quot; width=&quot;28&quot; height=&quot;28&quot; fill=&quot;#D3DEF0&quot;&gt;<br />&lt;path d=&quot;M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z&quot; /&gt;<br />&lt;/svg&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;span className=&quot;ml-4 text-lg&quot;&gt;<br />All free features included&lt;/span&gt;<br />
                        &lt;/span&gt;<br />
                        &lt;div className=&quot;w-full flex justify-center&quot;&gt;<br />
                        &lt;Link href=&quot;#&quot; passHref&gt;<br />
                        &lt;button className=&quot;py-2 px-12 bg-cl-secondary text-cl-blue-dark text-xl font-medium rounded-full&quot;&gt;<br />Choose Plan&lt;/button&gt;<br />
                        &lt;/Link&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;/div&gt;<br />
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl my-3' id="">
                ...
                <div style={{ height: code1 ? '400px' : '0', display: code1 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        ...
                        &lt;div className=&quot;w-full overflow-auto py-10&quot;&gt;<br />

                        &lt;div className=&quot;md:h-96 mx-10 md:w-3/4 md:bg-transparent bg-cl-blue-dark xl:w-[1000px] m-auto p-2 rounded-2xl overflow-y-hidden&quot;&gt;<br />
                        ...
                        &lt;h3 className=&quot;text-3xl sm:text-4xl md:float-right md:relative md:top-5 m-5 md:m-0 md:right-24 text-w md:text-cl-blue-dark&quot;&gt;<br />TailUI&lt;/h3&gt;<br />
                        &lt;div className=&quot;md:mt-16 lg:mt-8 py-5 md:float-right px-5 md:px-16 w-full md:w-3/4 lg:w-auto md:relative left-20 lg:left-0 bg-cl-blue-dark md:rounded-tr-[100px] md:rounded-bl-[100px]&quot;&gt;<br />
                        ...
                        &lt;/div&gt;<br />
                        &lt;div className=&quot;flex md:float-right mt-2 mx-5  md:text-cl-blue-dark &quot;&gt;<br />
                        &lt;Link href=&quot;#&quot; passHref&gt;<br />&lt;button className=&quot;mx-5&quot;&gt;<br />

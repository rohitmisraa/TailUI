...
export default function Portfolios() {
    ...
    return (
        <div className='p-10 min-h-screen'>
            ...
            <Link href={'/blocks/demo/dev-portfolio'} passHref><a target={'_blank'}>
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl'>
                ...
                <div style={{ height: code1 ? '400px' : '0', display: code1 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        &lt;div class=&quot;w-full overflow-x-hidden bg-skin-bas bg-[#14070b] scroll-smooth&quot;&gt;<br />
                            &lt;div class=&quot; max-w-[1500px] m-auto&quot;&gt;<br />

                                &lt;div class=&quot;py-7 px-5 sm:px-32 w-full flex justify-between&quot;&gt;<br />
                                    &lt;div class=&quot;h-10 md:ml-0 w-32 flex&quot;&gt;<br />
                                    ...
                                    &lt;div class=&quot;py-1 w-max px-2 text-lg font-medium hidden sm:flex&quot;&gt;<br />
                                        &lt;Link href=&quot;#projects&quot; passHref&gt;<br />&lt;button class=&quot;py-1 px-6 text-skin-dark  hover:relative hover:bottom-2&quot;&gt;<br />
                                            Projects&lt;/button&gt;<br />&lt;/Link&gt;<br />
                                        &lt;Link href=&quot;https://blog.tailui.xyz&quot; passHref&gt;<br />&lt;a target=&quot;_blank&quot;&gt;<br />&lt;button class=&quot;py-1 px-6 text-skin-dark  hover:relative hover:bottom-2&quot;&gt;<br />
                                            Blog&lt;/button&gt;<br />&lt;/a&gt;<br />&lt;/Link&gt;<br />
                                        &lt;Link href=&quot;#contact&quot; passHref&gt;<br />&lt;button class=&quot;py-1 px-6 text-skin-dark hover:relative hover:bottom-2&quot;&gt;<br />
                                            Contact&lt;/button&gt;<br />&lt;/Link&gt;<br />
                                    &lt;/div&gt;<br />
                                &lt;/div&gt;<br />
                                &lt;div class=&quot;py-3 px-5 md:px-20 w-full sm:w-11/12 xl:w-11/12 m-auto pt-44 flex&quot;&gt;<br />
                                    &lt;div class=&quot;w-full lg:w-3/6&quot;&gt;<br />
                                        &lt;h3 class=&quot;text-cl-cyan italic&quot;&gt;<br />Welcome, My name is&lt;/h3&gt;<br />
                                        &lt;p class=&quot;text-6xl text-cl-secondary md:w-[500px] xl:w-[650px]&quot;&gt;<br />Rohit kr Mishra&lt;/p&gt;<br />
                                        &lt;h1 class=&quot;lg:text-6xl w-full text-4xl md:w-[500px] xl:w-[700px] mb-2 text-cl-red&quot;&gt;<br />I make web and Mobile Apps&lt;/h1&gt;<br />
                                        &lt;p class=&quot;text-xl text-cl-secondary xl:w-[650px]&quot;&gt;<br />I am a Student and devloper from India, I have built 5+ apps in React, Next JS, Express, PHP, Dart and always looking new interesting Projects. Do you have any project for me? Contact or Checkout my other works below.&lt;/p&gt;<br />
                                        &lt;div class=&quot;flex space-x-4 mt-10&quot;&gt;<br />
                                            &lt;Link href=&quot;#contact&quot; passHref&gt;<br />
                                                &lt;button class=&quot;py-2 px-10 bg-gradient-to-r from-gr_red-1 to-gr_red-2 text-white text-base rounded-full&quot;&gt;<br />Contact Me&lt;/button&gt;<br />
                                            &lt;/Link&gt;<br />
                                            &lt;Link href=&quot;#projects&quot; passHref&gt;<br />
                                                &lt;button class=&quot;py-2 px-10 border-4 border-cl-secondary text-cl-secondary text-base rounded-full hover:bg-cl-secondary hover:text-cl-blue-dark&quot;&gt;<br />Projects&lt;/button&gt;<br />
                                            &lt;/Link&gt;<br />
                                        &lt;/div&gt;<br />
                                    &lt;/div&gt;<br />
                                    &lt;img src=&quot;/assets/cdn/orange-back-dark.png&quot; alt=&quot;Fitness image&quot; class=&quot;sm:w-80 sm:h-80 lg:w-[500px] lg:h-[500px] my-5  m-auto hidden md:block relative bottom-16&quot; /&gt;<br />
                                &lt;/div&gt;<br />


                                &lt;div class=&quot;py-3 px-5 md:px-20 w-full sm:w-11/12 xl:w-4/5 m-auto pt-44&quot;&gt;<br />
                                    &lt;h2 class=&quot;text-3xl my-4 text-cl-secondary &quot;&gt;<br />My Skills&lt;/h2&gt;<br />
                                    &lt;div class=&quot;w-max grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 m-auto gap-3&quot;&gt;<br />
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />JavaScript&lt;/h3&gt;<br />
                                        ...
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />TypeScript&lt;/h3&gt;<br />
                                                &lt;h4&gt;<br />Frontend&lt;/h4&gt;<br />
                                            &lt;/div&gt;<br />
                                        &lt;/div&gt;<br />
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />Nodejs&lt;/h3&gt;<br />
                                                &lt;h4&gt;<br />Server&lt;/h4&gt;<br />
                                            &lt;/div&gt;<br />
                                        &lt;/div&gt;<br />
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />MongoDB&lt;/h3&gt;<br />
                                                &lt;h4&gt;<br />Server&lt;/h4&gt;<br />
                                            &lt;/div&gt;<br />
                                        &lt;/div&gt;<br />
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />HTML&lt;/h3&gt;<br />
                                                &lt;h4&gt;<br />Frontend&lt;/h4&gt;<br />
                                            &lt;/div&gt;<br />
                                        &lt;/div&gt;<br />
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />CSS&lt;/h3&gt;<br />
                                                &lt;h4&gt;<br />Frontend&lt;/h4&gt;<br />
                                            &lt;/div&gt;<br />
                                        &lt;/div&gt;<br />
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />React&lt;/h3&gt;<br />
                                                &lt;h4&gt;<br />Frontend&lt;/h4&gt;<br />
                                            &lt;/div&gt;<br />
                                        &lt;/div&gt;<br />
                                        &lt;div class=&quot;flex bg-cl-secondary h-24 px-5 py-1 rounded-xl overflow-hidden&quot;&gt;<br />
                                            ...
                                            &lt;div class=&quot;ml-3&quot;&gt;<br />
                                                &lt;h3 class=&quot;text-xl font-bold&quot;&gt;<br />Express Js&lt;/h3&gt;<br />
                                                &lt;h4&gt;<br />Frontend&lt;/h4&gt;<br />
                                            &lt;/div&gt;<br />
                                        &lt;/div&gt;<br />
                                    &lt;/div&gt;<br />
                                ...
                                &lt;/div&gt;<br />
                                &lt;div class=&quot;py-3 px-5 md:px-20 w-full sm:w-11/12 xl:w-4/5 m-auto pt-44&quot; id=&quot;projects&quot;&gt;<br />
                                    &lt;h2 class=&quot;text-3xl text-cl-secondary&quot;&gt;<br />My Projects&lt;/h2&gt;<br />
                                    &lt;div class=&quot;mt-6 mb-3 flex&quot;&gt;<br />
                                        &lt;span class=&quot;text-xl text-cl-red&quot;&gt;<br />01. TailUI&lt;/span&gt;<br />
                                        &lt;div class=&quot;h-1 rounded-2xl bg-gradient-to-r from-gr_green-1 to-gr_green-2 w-32 relative top-3 ml-5&quot;&gt;<br />&lt;/div&gt;<br />
                                    &lt;/div&gt;<br />
                                    &lt;div class=&apos;md:h-[400px] xm:mx-10 w-full md:bg-transparent bg-cl-black-carbon m-auto p-2 rounded-2xl overflow-y-hidden&apos;&gt;<br />
                                        &lt;div class=&apos;h-96 w-full md:w-[500px] rounded-[40px] overflow-hidden&apos;&gt;<br />
                                            &lt;img class=&apos;h-full object-cover object-left&apos;
                                        ...
                                        &lt;div class=&apos;md:float-right w-full md:p-0 md:w-[600px] md:relative md:bottom-96 text-white&apos;&gt;<br />
                                            &lt;h3 class=&apos;text-3xl sm:text-4xl md:float-right md:relative md:top-5 m-5 md:m-0 md:right-24 text-w md:text-white&apos;&gt;<br />TailUI&lt;/h3&gt;<br />
                                            &lt;div class=&apos;md:mt-16 lg:mt-8 py-5 md:float-right px-5 md:px-16 w-full md:w-3/4 lg:w-auto md:relative left-20 lg:left-0 bg-cl-black-carbon md:rounded-tr-[100px] md:rounded-bl-[100px] sm:shadow-xl&apos;&gt;<br />
                                            ...
                                            &lt;/div&gt;<br />
                                            &lt;div class=&apos;flex md:float-right mt-2 mx-5  md:text-white&apos;&gt;<br />
                                                &lt;Link href=&quot;https://tailui.xyz&quot; passHref&gt;<br />&lt;a target=&quot;_blank&quot;&gt;<br />
                                                    &lt;button class=&apos;mx-5&apos;&gt;<br />
                                ...
                                &lt;/div&gt;<br />
                                &lt;div class=&quot;text-center pt-60&quot; id=&quot;contact&quot;&gt;<br />
                                    &lt;h2 class=&quot;text-3xl text-cl-secondary&quot;&gt;<br />Have any Idea or Project?&lt;/h2&gt;<br />
                                    &lt;p class=&quot;text-xl my-6 text-cl-secondary&quot;&gt;<br />Or just want to say Hi!&lt;/p&gt;<br />
                                    &lt;Link href=&quot;mailto:fakemail@tailui.xyz&quot; passHref&gt;<br />&lt;a target=&quot;_blank&quot;&gt;<br />
                                        &lt;button class=&quot;py-2 px-10 border-4 border-cl-secondary text-cl-secondary text-base rounded-full hover:bg-cl-secondary hover:text-cl-blue-dark&quot;&gt;<br />Send a message&lt;/button&gt;<br />
                                    &lt;/a&gt;<br />&lt;/Link&gt;<br />
                                    &lt;h4 class=&quot;mt-40 mb-3 text-2xl text-cl-secondary flex w-max m-auto space-x-1&quot;&gt;<br />
                                        ...
                                        &lt;span&gt;<br />using &lt;Link href=&quot;https://tailui.xyz&quot; passHref&gt;<br />&lt;a class=&quot;text-cl-red&quot; target=&quot;_blank&quot;&gt;<br />TailUI&lt;/a&gt;<br />&lt;/Link&gt;<br />&lt;/span&gt;<br />
                                    &lt;/h4&gt;<br />
                                &lt;/div&gt;<br />

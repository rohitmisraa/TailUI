        ...
        <div className='p-10 min-h-screen'>
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl'>
                ...
                <div style={{ height: code2 ? '400px' : '0', display: code2 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        &lt;div className=&quot;w-full overflow-x-hidden bg-skin-bas bg-cl-blue min-h-screen bg-no-repeat bg-cover bg-[url(&apos;/assets/pexels-belle-co-847393.jpg&apos;)]&quot;&gt;<br />
                            &lt;div className=&quot;py-3 px-5 sm:px-20 w-screen flex justify-between bg-[#FFCCC2]&quot;&gt;<br />
                                &lt;div className=&quot;h-10 w-32 flex&quot;&gt;<br />
                                    &lt;img src=&quot;/assets/tailui-icon.svg&quot; alt=&quot;Logo&quot; className=&quot;object-contain h-8 w-h-8&quot; /&gt;<br />
                                    &lt;span className=&quot;text-xl ml-3 relative top-1 text-cl-black-carbon&quot;&gt;<br />
                                        TailUI&lt;/span&gt;<br />
                                &lt;/div&gt;<br />
                                &lt;div className=&quot;py-1 w-max px-2 text-lg font-medium hidden sm:flex&quot;&gt;<br />
                                    &lt;button className=&quot;py-1 px-6 text-cl-black-carbon  hover:relative hover:bottom-2&quot;&gt;<br />
                                        Home&lt;/button&gt;<br />
                                    &lt;button className=&quot;py-1 px-6 text-cl-grey-dark  hover:relative hover:bottom-2&quot;&gt;<br />
                                        About&lt;/button&gt;<br />
                                    &lt;button className=&quot;py-1 px-6 text-cl-grey-dark hover:relative hover:bottom-2&quot;&gt;<br />
                                        Contact&lt;/button&gt;<br />
                                &lt;/div&gt;<br />
                                &lt;div className=&quot;bg-[#FFCCC2] h-screen w-0 sm:w-7 absolute float-left top-0 left-0&quot;&gt;<br />&lt;/div&gt;<br />
                                &lt;div className=&quot;bg-[#FFCCC2] h-screen w-0 sm:w-7 absolute float-right top-0 right-0&quot;&gt;<br />&lt;/div&gt;<br />

                            &lt;/div&gt;<br />
                            &lt;div className=&quot;py-3 px-10 sm:px-20 w-screen flex justify-between pt-44 space-x-4&quot;&gt;<br />
                                &lt;div className=&quot;w-full lg:w-3/6&quot;&gt;<br />
                                    &lt;h1 className=&quot;lg:text-7xl w-full text-5xl xl:w-[650px] text-white&quot;&gt;<br /> We &lt;span className=&quot;font-bold text-[#FD8067]&quot;&gt;<br />CLEAN&lt;/span&gt;<br /> Water and make it healthier&lt;/h1&gt;<br />
                                    &lt;p className=&quot;text-xl text-cl-secondary xl:w-[650px]&quot;&gt;<br />We are on a journey to clean ocean water and thousands of beaches, you can also help in this journey by donating.&lt;/p&gt;<br />
                                    &lt;div className=&quot;flex space-x-4 mt-10&quot;&gt;<br />
                                        &lt;button className=&quot;py-1 px-6 bg-[#FD8067] text-white text-base rounded-full&quot;&gt;<br />Learn More&lt;/button&gt;<br />
                                        &lt;button className=&quot;py-1 px-6 bg-cl-secondary text-cl-blue-dark text-base rounded-full&quot;&gt;<br />Check our blog&lt;/button&gt;<br />
                                    &lt;/div&gt;<br />
                                &lt;/div&gt;<br />
                            &lt;/div&gt;<br />
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl'>
                ...
                <div style={{ height: code3 ? '400px' : '0', display: code3 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    <pre className='px-5 block overflow-auto whitespace-pr'><code className='px-5 overflow-auto h-96 block text-white language-html' id='code1'>
                        &lt;div className=&quot;w-full overflow-x-hidden bg-skin-bas bg-[#EBEBEB]&quot;&gt;<br />
                            &lt;div className=&quot;py-3 px-5 sm:px-20 w-screen flex justify-between pt-5 fixed z-40&quot;&gt;<br />
                                &lt;div className=&quot;h-10 w-32 flex&quot;&gt;<br />
                                    &lt;img src=&quot;/assets/TailUI-icon.svg&quot; alt=&quot;Logo&quot; className=&quot;object-contain h-8 w-h-8&quot; /&gt;<br />
                                    &lt;span className=&quot;text-xl ml-3 relative top-1 text-cl-black-carbon&quot;&gt;<br />
                                        TailUI Pay&lt;/span&gt;<br />
                            ...
                            &lt;/div&gt;<br />
                            &lt;div className=&quot;py-3 w-screen h-screen overflow-hidden pt-44 md:pt-10 mt-24&quot;&gt;<br />
                                &lt;div className=&quot;w-full&quot;&gt;<br />
                                    &lt;h1 className=&quot;text-5xl w-full md:w-[650px] text-cl-black-carbon font-light m-auto text-center z-20 relative&quot;&gt;<br />We help to send money by one click&lt;/h1&gt;<br />
                                    &lt;div className=&quot; w-40 m-auto my-7&quot;&gt;<br />
                                        &lt;button className=&quot;py-1 px-6 bg-cl-blue text-white text-base rounded-full relative z-20&quot;&gt;<br />Learn More&lt;/button&gt;<br />
            ...
            <div className=' w-full bg-cl-blue-dark rounded-xl'>
                ...
                <div style={{ height: code4 ? '400px' : '0', display: code4 ? 'block' : 'none' }} className='w-full bg-cl-blue-dark rounded-xl'>
                    ...
                    &lt;div className=&quot;w-full overflow-x-hidden bg-skin-base min-h-screen&quot;&gt;<br />
                    &lt;div className=&quot;py-3 px-10 lg:px-20 w-screen flex justify-between fixed max-h-20  z-20 bg-white/5 backdrop-blur-md&quot;&gt;<br />
                            &lt;div className=&apos;flex text-skin-dark&apos;&gt;<br />
                                &lt;button className=&quot;py-1 px-2  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 block lg:hidden&quot;&gt;<br />
                                ...
                                &lt;/button&gt;<br />
                                &lt;div className=&quot;h-10 relative top-2 mx-2 w-auto flex&quot;&gt;<br />
                                    &lt;img src=&quot;/assets/tailui-icon.svg&quot; alt=&quot;Logo&quot; className=&quot;object-contain h-8 w-h-8 shadow-sm&quot; /&gt;<br />
                                    &lt;span className=&quot;text-xl ml-3 relative top-1 sm:block hidden&quot;&gt;<br />TailUI&lt;/span&gt;<br />
                                &lt;/div&gt;<br />
                                &lt;div className=&apos;flex bg-cl-secondary rounded-full my-1&apos;&gt;<br />
                                    &lt;input
                                    ...
                                    /&gt;<br />
                                    &lt;button className=&quot;px-6 py-0 bg-cl-blue text-white text-base rounded-full&quot;&gt;<br />Search&lt;/button&gt;<br />
                                &lt;/div&gt;<br />

                            &lt;/div&gt;<br />

                            &lt;div className=&quot;flex py-1 w-max text-skin-light px-2 text-lg font-medium&quot;&gt;<br />
                                &lt;Link href=&apos;/&apos; passHref&gt;<br />
                                    &lt;button className=&quot;py-1 px-6  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 hidden lg:block&quot;&gt;<br />Home&lt;/button&gt;<br />&lt;/Link&gt;<br />
                                &lt;Link href=&apos;/&apos; passHref&gt;<br />&lt;button className=&quot;py-1 px-6  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 hidden lg:block&quot;&gt;<br />Documentation&lt;/button&gt;<br />&lt;/Link&gt;<br />
                                &lt;Link href=&apos;/components/buttons&apos; passHref&gt;<br />&lt;button className=&quot;py-1 px-6  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 hidden lg:block&quot;&gt;<br />Components&lt;/button&gt;<br />&lt;/Link&gt;<br />
                                &lt;Link href=&apos;/&apos; passHref&gt;<br />&lt;button className=&quot;py-1 px-2 w-16  relative hover:text-cl-violet top-1 hover:font-medium hover:top-0 sm:block hidden&quot;&gt;<br />
                                    SVG.light_btn
                                &lt;/button&gt;<br />&lt;/Link&gt;<br />
                                &lt;Link href=&apos;/github.com&apos; passHref&gt;<br />&lt;button className=&quot;py-1 px-2  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 sm:block hidden&quot;&gt;<br />
                    ...
                    &lt;div className=&quot;py-3 px-5 sm:px-20 w-screen flex justify-between pt-44 space-x-4&quot;&gt;<br />
                        &lt;div className=&quot;w-full lg:w-3/6&quot;&gt;<br />
                            &lt;h1 className=&quot;lg:text-7xl w-full text-5xl xl:w-[650px] text-skin-dark&quot;&gt;<br />&lt;span className=&quot;font-bold text-gr_violet-2&quot;&gt;<br />TailUI &lt;/span&gt;<br />- Tailwind Component library and templates&lt;/h1&gt;<br />
                            &lt;p className=&quot;text-xl text-skin-light xl:w-[650px] mt-5&quot;&gt;<br />A Tailwind library with 50+ components, Make your app using our library without much effort.&lt;/p&gt;<br />
                            &lt;div className=&quot;flex space-x-4 mt-10&quot;&gt;<br />
                            &lt;Link href=&apos;/components/buttons&apos; passHref&gt;<br />&lt;button className=&quot;py-3 px-10 bg-gradient-to-r from-gr_violet-1 to-gr_violet-2 text-white text-lg rounded-lg&quot;&gt;<br />Components&lt;/button&gt;<br />&lt;/Link&gt;<br />
                            &lt;Link href=&apos;/&apos; passHref&gt;<br />&lt;button className=&quot;py-3 px-10 bg-cl-secondary text-cl-blue-dark text-lg rounded-lg&quot;&gt;<br />Documentation&lt;/button&gt;<br />&lt;/Link&gt;<br />
                            &lt;/div&gt;<br />
                        &lt;/div&gt;<br />
                        &lt;img src=&quot;/assets/undraw_product_teardown_re_m1pc.svg&quot; alt=&quot;Fitness image&quot; className=&quot;sm:w-3/6 lg:w-[500px] xl:w-[700px] my-5 xl:my-0 m-auto hidden md:block relative bottom-16&quot; /&gt;<br />
                    &lt;/div&gt;<br />
                &lt;/div&gt;<br />

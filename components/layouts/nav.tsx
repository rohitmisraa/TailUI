  ...
  return (
    <div className="py-3 px-10 lg:px-20 w-screen flex justify-between fixed max-h-20  z-20 bg-white/5 backdrop-blur-md">
          ...
          <button className="py-1 px-2  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 block lg:hidden" onClick={showMenu}>
            ...
            <button className="py-1 px-6  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 hidden lg:block">Home</button>
            <button className="py-1 px-6  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 hidden lg:block">Documentations</button>
            <button className="py-1 px-6  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 hidden lg:block">Components</button>
            <button className="py-1 px-2  hover:relative hover:text-cl-violet hover:font-medium hover:bottom-1 sm:block hidden">
